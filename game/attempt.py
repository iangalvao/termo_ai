...
class Attempt:
    ...
    def mark_position_hints(self, guess: str, correct_word: str, feedbacks: list[int]) -> list[Hint]:
    ...
    def unmark_excess_wrong_pos(self, guess: str, correct_word: str, feedbacks: list[int]) -> list[Hint]:
